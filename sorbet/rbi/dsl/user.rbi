...
class User
  ...
  module GeneratedAssociationMethods
    ...
    def build_primary_account(*args, &blk); end
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.nilable(::String)) }
    def primary_account_id_before_last_save; end

    sig { returns(T.untyped) }
    def primary_account_id_before_type_cast; end
    ...
    sig { returns(T::Boolean) }
    def primary_account_id_changed?; end
    ...
    sig { returns(T::Boolean) }
    def primary_account_id_previously_changed?; end

    sig { returns(T.nilable(::String)) }
    def primary_account_id_previously_was; end

    sig { returns(T.nilable(::String)) }
    def primary_account_id_was; end

    sig { void }
    def primary_account_id_will_change!; end
    ...
    sig { void }
    def restore_primary_account_id!; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_primary_account_id?; end
