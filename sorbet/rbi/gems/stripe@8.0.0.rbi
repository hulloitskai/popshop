...
module Stripe::APIOperations::Save
  ...
  # source://stripe//lib/stripe/api_operations/save.rb#90
  def save_url; end

  class << self
    # @private
    #
    # source://stripe//lib/stripe/api_operations/save.rb#77
    def included(base); end
  end
end
...
#
# source://stripe//lib/stripe/resources/account.rb#11
class Stripe::Account < ::Stripe::APIResource
  ...
  # source://stripe//lib/stripe/resources/account.rb#156
  ...
  # source://stripe//lib/stripe/resources/account.rb#145
  def legal_entity; end

  # @raise [NoMethodError]
  #
  # source://stripe//lib/stripe/resources/account.rb#149
  def legal_entity=(_legal_entity); end

  # source://stripe//lib/stripe/resources/account.rb#27
  def persons(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://stripe//lib/stripe/resources/account.rb#36
  ...
  #
  # source://stripe//lib/stripe/resources/account.rb#121
  def serialize_params(options = T.unsafe(nil)); end

  # source://stripe//lib/stripe/resources/account.rb#125
  def serialize_params_account(_obj, update_hash, options = T.unsafe(nil)); end

  private

  # source://stripe//lib/stripe/resources/account.rb#165
  ...
  class << self
    ...
    # source://stripe//lib/stripe/resources/account.rb#45
    ...
    # source://stripe//lib/stripe/resources/account.rb#79
...
# source://stripe//lib/stripe/resources/account.rb#19
...
#
# source://stripe//lib/stripe/resources/invoice_item.rb#12
...
# source://stripe//lib/stripe/resources/invoice_item.rb#18
...
class Stripe::Subscription < ::Stripe::APIResource
  ...
  class << self
    ...
    # source://stripe//lib/stripe/resources/subscription.rb#58
    def search_auto_paging_each(params = T.unsafe(nil), opts = T.unsafe(nil), &blk); end
  end
end
...
# source://stripe//lib/stripe/resources/terminal/reader.rb#93
class Stripe::Terminal::Reader::TestHelpers < ::Stripe::APIResourceTestHelpers
  # source://stripe//lib/stripe/resources/terminal/reader.rb#105
  def present_payment_method(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  class << self
    # source://stripe//lib/stripe/resources/terminal/reader.rb#96
    def present_payment_method(reader, params = T.unsafe(nil), opts = T.unsafe(nil)); end
  end
end

# source://stripe//lib/stripe/resources/terminal/reader.rb#94
...
module Stripe::Util
  class << self
    ...
    # @raise [TypeError]
    #
    # source://stripe//lib/stripe/util.rb#292
    ...
    # `&`).
    #
    # source://stripe//lib/stripe/util.rb#205
    ...
    # source://stripe//lib/stripe/util.rb#171
    def log_debug(message, data = T.unsafe(nil)); end

    # source://stripe//lib/stripe/util.rb#151
    def log_error(message, data = T.unsafe(nil)); end

    # source://stripe//lib/stripe/util.rb#161
    ...
    #
    # source://stripe//lib/stripe/util.rb#262
    ...
    #
    # source://stripe//lib/stripe/util.rb#309
    ...
    #
    # source://stripe//lib/stripe/util.rb#278
    ...
    #
    # source://stripe//lib/stripe/util.rb#321
    def request_id_dashboard_url(request_id, api_key); end

    # Constant time string comparison to prevent timing attacks
    # Code borrowed from ActiveSupport
    #
    # source://stripe//lib/stripe/util.rb#328
    def secure_compare(str_a, str_b); end

    # source://stripe//lib/stripe/util.rb#181
    ...
    # body.
    #
    # source://stripe//lib/stripe/util.rb#213
...
# private
#
# source://stripe//lib/stripe/util.rb#342
