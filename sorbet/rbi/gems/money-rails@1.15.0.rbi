...
# source://money-rails//lib/money-rails/active_model/validator.rb#137
...
# source://money-rails//lib/money-rails/active_model/validator.rb#2
module MoneyRails::ActiveModel; end

# source://money-rails//lib/money-rails/active_model/validator.rb#3
class MoneyRails::ActiveModel::MoneyValidator < ::ActiveModel::Validations::NumericalityValidator
  # source://money-rails//lib/money-rails/active_model/validator.rb#14
  def validate_each(record, attr, _value); end

  private

  # source://money-rails//lib/money-rails/active_model/validator.rb#78
  def add_error!(record, attr, details); end

  # source://money-rails//lib/money-rails/active_model/validator.rb#67
  def generate_details(raw_value, currency); end

  # source://money-rails//lib/money-rails/active_model/validator.rb#100
  def invalid_thousands_separation(details); end

  # source://money-rails//lib/money-rails/active_model/validator.rb#129
  def locale_backend; end

  # source://money-rails//lib/money-rails/active_model/validator.rb#121
  ...
  #
  # source://money-rails//lib/money-rails/active_model/validator.rb#113
  def normalize(details); end

  # @return [Boolean]
  #
  # source://money-rails//lib/money-rails/active_model/validator.rb#74
  def record_already_has_error?(record, attr, raw_value); end

  # source://money-rails//lib/money-rails/active_model/validator.rb#94
  def thousand_separator_after_decimal_mark(details); end

  # source://money-rails//lib/money-rails/active_model/validator.rb#90
  def value_has_too_many_decimal_points(details); end
end

# source://money-rails//lib/money-rails/active_model/validator.rb#62
MoneyRails::ActiveModel::MoneyValidator::DEFAULTS = T.let(T.unsafe(nil), Hash)

# source://money-rails//lib/money-rails/active_model/validator.rb#4
class MoneyRails::ActiveModel::MoneyValidator::Details < ::Struct
  # source://money-rails//lib/money-rails/active_model/validator.rb#5
  def abs_raw_value; end

  # source://money-rails//lib/money-rails/active_model/validator.rb#9
...
# source://money-rails//lib/money-rails/active_record/migration_extensions/options_extractor.rb#3
module MoneyRails::ActiveRecord::MigrationExtensions; end

# source://money-rails//lib/money-rails/active_record/migration_extensions/options_extractor.rb#4
class MoneyRails::ActiveRecord::MigrationExtensions::OptionsExtractor
  class << self
    # source://money-rails//lib/money-rails/active_record/migration_extensions/options_extractor.rb#5
    def extract(attribute, table_name, accessor, options = T.unsafe(nil)); end
  end
end

# source://money-rails//lib/money-rails/active_record/migration_extensions/schema_statements_pg_rails4.rb#4
module MoneyRails::ActiveRecord::MigrationExtensions::SchemaStatements
  # source://money-rails//lib/money-rails/active_record/migration_extensions/schema_statements_pg_rails4.rb#5
  def add_monetize(table_name, accessor, options = T.unsafe(nil)); end

  # source://money-rails//lib/money-rails/active_record/migration_extensions/schema_statements_pg_rails4.rb#13
  def remove_monetize(table_name, accessor, options = T.unsafe(nil)); end
end

# source://money-rails//lib/money-rails/active_record/migration_extensions/table_pg_rails4.rb#4
module MoneyRails::ActiveRecord::MigrationExtensions::Table
  # source://money-rails//lib/money-rails/active_record/migration_extensions/table_pg_rails4.rb#5
  def monetize(accessor, options = T.unsafe(nil)); end

  # source://money-rails//lib/money-rails/active_record/migration_extensions/table_pg_rails4.rb#13
  def remove_monetize(accessor, options = T.unsafe(nil)); end
end
