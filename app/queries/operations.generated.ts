...
export type ProductPageQuery = (
  ...
  & { viewer: Types.Maybe<(
    ...
    & { prices: Array<(
      { __typename?: 'Price' }
      & Pick<Types.Price, 'id' | 'name' | 'scope' | 'amount'>
      & { units: Types.Maybe<(
        { __typename?: 'Units' }
