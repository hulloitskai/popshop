...
export type ProductDeleteMutationVariables = Types.Exact<{
  input: Types.ProductDeleteInput;
}>;
...
export type ProductDeleteMutation = (
  ...
  & { payload: (
    ...
    & Pick<Types.ProductDeletePayload, 'success'>
  ) }
);
...
export type ProductEditPageQuery = (
  ...
  & { viewer: Types.Maybe<(
    ...
    { __typename?: 'Product' }
    & Pick<Types.Product, 'id' | 'deletedAt' | 'name' | 'description'>
    & { currency: (
      { __typename?: 'Currency' }
...
export type ProductPageProductFragment = (
  { __typename?: 'Product' }
  & Pick<Types.Product, 'name' | 'deletedAt' | 'canEdit' | 'editUrl' | 'description' | 'id'>
  & { currency: (
    { __typename?: 'Currency' }
    & Pick<Types.Currency, 'code' | 'exponent'>
  ), items: Array<(
...
export type ProductPageQuery = (
  ...
  & { viewer: Types.Maybe<(
    ...
    { __typename?: 'Product' }
    & Pick<Types.Product, 'id' | 'name' | 'deletedAt' | 'canEdit' | 'editUrl' | 'description'>
    & { currency: (
      { __typename?: 'Currency' }
      & Pick<Types.Currency, 'code' | 'exponent'>
    ), items: Array<(
...
export type UserEmailFormQuery = (
  ...
  & { viewer: Types.Maybe<(
    { __typename?: 'User' }
    & Pick<Types.User, 'id' | 'email' | 'unverifiedEmail'>
  )> }
);
...
export type UserSettingsPageQuery = (
  ...
  & { viewer: Types.Maybe<(
    { __typename?: 'User' }
    & Pick<Types.User, 'id' | 'name' | 'email' | 'unverifiedEmail'>
  )> }
);
...
export const ProductDeleteMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ProductDeleteMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ProductDeleteInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"payload"},"name":{"kind":"Name","value":"productDelete"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}}]}}]}}]} as unknown as DocumentNode<ProductDeleteMutation, ProductDeleteMutationVariables>;
